...
<v-form @submit.prevent="createOne()" ref="form"
  ...
  <v-flex xs12 md10>
              <v-text-field :rules="formNameRules" required solo label="Product Name" v-model="name"></v-text-field>
              <v-text-field type="number" :rules="formPriceRules" required solo label="Product Price" v-model="price"></v-text-field>
              <v-textarea :rules="formDescRules" required solo label="Product Description" v-model="desc"></v-textarea>
  </v-flex>
  <v-flex xs12 md2>
              <v-btn
              :disabled="!valid"
